import { IonContent, IonMenu, IonHeader, IonToolbar, IonTitle, IonList, IonItem, IonMenuToggle, IonPage, IonButtons, IonButton, IonIcon, IonGrid, IonLabel, IonMenuButton, IonSelect, IonSelectOption, IonRow, IonCol } from '@ionic/react';
import { add, filterOutline, personOutline, sunnyOutline } from 'ionicons/icons';
            ...
            <IonContent>
                ...
                <IonMenu menuId="second-menu" contentId="main-content">
                    ...
                    <IonContent className="ion-padding">
                        <IonItem>
                            <IonSelect label="Fixed label" labelPlacement="fixed" placeholder="Veg">
                        ...
                        <IonItem>
                            <IonSelect label="Fixed label" labelPlacement="fixed" placeholder="By Cuisines">
                                <IonSelectOption value="apple">All</IonSelectOption>
                                <IonSelectOption value="banana">Veg</IonSelectOption>
                                <IonSelectOption value="orange">Non-veg</IonSelectOption>
                            </IonSelect>
                        ...
                        <IonItem>
                            <IonSelect label="Fixed label" labelPlacement="fixed" placeholder="By Category">
                                <IonSelectOption value="apple">All</IonSelectOption>
                                <IonSelectOption value="banana">Veg</IonSelectOption>
                                <IonSelectOption value="orange">Non-veg</IonSelectOption>
                            </IonSelect>
                        ...
                        <IonItem>
                            <IonSelect label="Fixed label" labelPlacement="fixed" placeholder="Sort by">
                                <IonSelectOption value="apple">All</IonSelectOption>
                                <IonSelectOption value="banana">Veg</IonSelectOption>
                                <IonSelectOption value="orange">Non-veg</IonSelectOption>
                            </IonSelect>
